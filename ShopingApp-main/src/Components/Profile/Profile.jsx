...
import './Profile.css'
import profileImage from '../AboutCompany/MT2024022.jpg'
        ...
        <div class="profile-container">
            <div class="profile-header">
                ...
                <div class="profile-info">
                    <h1>{EditProfileInformati.uname || 'Ankit Sharma'}</h1>
                    <p>Premium Member</p>
            ...
            <div class="profile-body">
                <div class="profile-section">
                    ...
                    <p><strong>Email:</strong> {EditProfileInformati.uemail || 'anksharma99999@gmail.com'}</p>
                    <p><strong>Phone:</strong> {EditProfileInformati.uphone || '8860688367'}</p>
