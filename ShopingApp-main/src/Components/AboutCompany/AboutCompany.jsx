...
import image from './MT2024022.jpg'
    ...
    return (
        <div className="about-page">
            ...
            <section className="about-section about-team">
                ...
                <div className="team-grid">
                    <div className="team-member">
                        <img style={{ height: '320px', width: '320px', marginTop: '50px' }} src={image} alt="Ankit Sharma" />
                        <h3>Ankit Sharma</h3>
                        <p>Founder & CEO</p>
                    </div>
            ...
            <footer className="about-footer">
                ...
                <p>Contact us at: <Link to="mailto:anksharma99999@gmail.com">anksharma99999@gmail.com</Link></p>
            </footer>
        </div>
    );
};
